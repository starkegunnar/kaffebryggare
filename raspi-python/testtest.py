...
#Twitter strings
file = open('/home/pi/twitter/kaffe-greetings.txt','r')
greets = file.read().splitlines()
file.close()
file = open('/home/pi/twitter/kaffe-verbs.txt','r')
verbs = file.read().splitlines()
file.close()
file = open('/home/pi/twitter/kaffe-names.txt','r')
names = file.read().splitlines()
file.close()
file = open('/home/pi/twitter/kaffe-containers.txt', 'r')
conts = file.read().splitlines()
file.close()
file = open('/home/pi/twitter/kaffe-verbs2.txt', 'r')
verbs2 = file.read().splitlines()
file.close()
file = open('/home/pi/twitter/kaffe-hashtags.txt', 'r')
hashtags = file.read().splitlines()
file.close()
file = open('/home/pi/twitter/kaffe-handles.txt', 'r')
